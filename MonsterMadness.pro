...
MonsterMadnessRootPath=/media/bat/SecondSSD/Projects/Unreal/MonsterMadness

gameProjectFile=/media/bat/SecondSSD/Projects/Unreal/MonsterMadness/MonsterMadness.uproject
build=mono $$unrealRootPath/Engine/Binaries/DotNET/UnrealBuildTool.exe

args=$(ARGS)

include(MonsterMadnessSource.pri)
include(MonsterMadnessHeader.pri)
include(MonsterMadnessConfig.pri)
include(MonsterMadnessIncludes.pri)
include(MonsterMadnessDefines.pri)
...
MonsterMadness-Linux-Debug.commands = $$build MonsterMadness Linux Debug  -project="\"$$gameProjectFile\"" $$args
MonsterMadness-Linux-DebugGame.commands = $$build MonsterMadness Linux DebugGame  -project="\"$$gameProjectFile\"" $$args
MonsterMadness-Linux-Shipping.commands = $$build MonsterMadness Linux Shipping  -project="\"$$gameProjectFile\"" $$args
MonsterMadness-Linux-Test.commands = $$build MonsterMadness Linux Test  -project="\"$$gameProjectFile\"" $$args
MonsterMadness.commands = $$build MonsterMadness Linux Development  -project="\"$$gameProjectFile\"" $$args

MonsterMadnessEditor-Linux-Debug.commands = $$build MonsterMadnessEditor Linux Debug  -project="\"$$gameProjectFile\"" $$args
MonsterMadnessEditor-Linux-DebugGame.commands = $$build MonsterMadnessEditor Linux DebugGame  -project="\"$$gameProjectFile\"" $$args
MonsterMadnessEditor-Linux-Shipping.commands = $$build MonsterMadnessEditor Linux Shipping  -project="\"$$gameProjectFile\"" $$args
MonsterMadnessEditor-Linux-Test.commands = $$build MonsterMadnessEditor Linux Test  -project="\"$$gameProjectFile\"" $$args
MonsterMadnessEditor.commands = $$build MonsterMadnessEditor Linux Development  -project="\"$$gameProjectFile\"" $$args
...
QMAKE_EXTRA_TARGETS += \ 
	...
	MonsterMadness-Linux-Debug \
	MonsterMadness-Linux-DebugGame \
	MonsterMadness-Linux-Shipping \
	MonsterMadness-Linux-Test \
	MonsterMadness \
	MonsterMadnessEditor-Linux-Debug \
	MonsterMadnessEditor-Linux-DebugGame \
	MonsterMadnessEditor-Linux-Shipping \
	MonsterMadnessEditor-Linux-Test \
	MonsterMadnessEditor \
